...
Crée des grilles de tarifs par import de fichier texte.
...
Nom=ImporterGrillesTarifs


Journal=ImporterGrillesTarifs.log
...
FichierImporter=ImporterGrillesTarifs.txt
