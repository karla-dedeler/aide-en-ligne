...
Crée des documents d'achat par import de fichier texte.
...
Nom=ImporterDocumentsAchat


Journal=ImporterDocumentsAchat.log
...
FichierImporter=ImporterDocumentsAchat.txt
