# ImporterReferencesClientsArticles
...
Crée des références clients d'articles seules par import de fichier texte.
...
Nom=ImporterReferencesClients


Journal=ImporterReferencesClients.log
...
FichierImporter=ImporterReferencesClients.txt
