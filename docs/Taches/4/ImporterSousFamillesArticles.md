...
Crée des sous-familles d'articles par import de fichier texte.
...
Nom=ImporterSousFamillesArticles


Journal=ImporterSousFamillesArticles.log
...
FichierImporter=ImporterSousFamillesArticles.txt
