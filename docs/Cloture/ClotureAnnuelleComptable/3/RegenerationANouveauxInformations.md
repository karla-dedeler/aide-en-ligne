# La regénération des écritures d'A-Nouveaux : Informations

Cet écran vous informe des actions spécifiques que le traitement 
 va effectuer pour :
...
Une écriture dans le journal des A-nouveaux représentera le solde des 
 écritures saisies au cours de l’exercice que vous clôturez ;
